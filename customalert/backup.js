         ...
         /************************************** CUSTOME BUTTON***************************************/ 
			...
			/*	var defaults = {   
				...
				// message Style
				{
					...
					/*$("#message").css({'font-size':options.message["font-size"]});
					$("#message").css({'font-weight':options.message["font-weight"]});
					$("#message").css({'color':options.message["color"]});*/
				}
				...
				//container Style 
				{
					...
					/*$("#alertMsgDiv").css({'width':options.containerStyle["width"]});
					$("#alertMsgDiv").css({'border':options.containerStyle["border"]});*/
